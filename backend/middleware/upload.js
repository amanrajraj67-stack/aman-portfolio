...
const storage = new CloudinaryStorage({
    ...
    params: {
        folder: process.env.CLOUDINARY_FOLDER ? `${process.env.CLOUDINARY_FOLDER}/images` : 'portfolio/images',
...
const videoStorage = new CloudinaryStorage({
    ...
    params: async (req, file) => {
        ...
        return {
            folder: process.env.CLOUDINARY_FOLDER ? `${process.env.CLOUDINARY_FOLDER}/videos` : 'portfolio/videos',
            resource_type: 'video',
