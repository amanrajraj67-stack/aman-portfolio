                                ...
                                <div className={styles.metaCard}>
                                    <div className={styles.authorInfo}>
                                        ...
                                        <div className={styles.authorDetails}>
                                            <span className={styles.authorName}>{post.author || portfolioConfig.name || 'Author'}</span>
                                            <span className={styles.authorRole}>{portfolioConfig.role || 'Full-Stack Developer'}</span>
                                        </div>
                                    </div>
                            ...
                            <footer className={styles.articleFooter}>
                                ...
                                <div className={styles.authorCard}>
                                    <div className={styles.authorCardHeader}>
                                        <div className={styles.cardAvatar}>{(post.author || portfolioConfig.name || 'A')[0].toUpperCase()}</div>
                                        <div>
                                            <h4 className={styles.cardAuthorName}>Written by {post.author || portfolioConfig.name || 'Author'}</h4>
                                            <p className={styles.cardAuthorBio}>
                                                {portfolioConfig.description || 'Full-stack engineer passionate about modern web technologies, AI integrations, and high-performance applications.'}
                                            </p>
                                        </div>
                                    </div>
                                    {(portfolioConfig.socialLinks?.github || portfolioConfig.socialLinks?.linkedin) && (
                                        <div className={styles.authorSocials}>
                                            {portfolioConfig.socialLinks?.github && (
                                                <a href={portfolioConfig.socialLinks.github} target="_blank" rel="noopener noreferrer">
                                                    <FaGithub /> GitHub
                                                </a>
                                            )}
                                            {portfolioConfig.socialLinks?.linkedin && (
                                                <a href={portfolioConfig.socialLinks.linkedin} target="_blank" rel="noopener noreferrer">
                                                    <FaLinkedin /> LinkedIn
                                                </a>
                                            )}
                                        </div>
